...
module.exports = {
  ...
  info: {
    ...
    usage: 'exam <datum> <examen>',
    examples: ['exam 12/5 Biologie', 'examen 19-5']
  },
  async execute(message, args, client, discord, profileData) {
    ...
    try {
      ...
      message.channel.send(`Er is een fout opgetreden bij het toevoegen van een examen in de database.`);
    }
  }
}